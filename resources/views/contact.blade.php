  ...
  <div class="max-w-4xl mx-auto">
    <div class="flex flex-col md:flex-row items-center md:items-start md:space-x-6 mb-8">
      ...
      <div class="mt-4 md:mt-0">
        ...
        <p class="text-green-400">{{ __('site.contact_role') }}</p>
        <p class="text-sm text-gray-400 mt-1">Laravel | Flutter | Vue | Svelte | Golang</p>
        <p class="text-sm text-gray-400">{{ __('site.contact_location') }}</p>
      </div>
    </div>

    <!-- WhatsApp Contact Form -->
    <div class="bg-gray-800 rounded-lg p-6 mb-10 border-l-4 border-green-500 shadow-lg">
      <h2 class="text-2xl font-semibold text-green-400 mb-4">{{ __('site.contact_wa_heading') }}</h2>
      <form id="whatsappForm" class="space-y-4">
        <div>
          <label for="name" class="block text-sm font-medium text-gray-300 mb-1">{{ __('site.contact_label_name') }}</label>
        ...
        <div>
          <label for="message" class="block text-sm font-medium text-gray-300 mb-1">{{ __('site.contact_label_message') }}</label>
    ...
    <section class="mb-10">
      ...
      <p class="text-gray-300 leading-relaxed">
        {{ __('site.contact_about_intro') }}<br><br>

        {{ __('site.contact_about_skills_label') }}<br>
        ...
        {{ __('site.contact_about_portfolio') }}<br>
        {{ __('site.contact_about_open') }}
      </p>
    </section>

    <!-- Bagian lainnya tetap sama -->
    <section class="mb-10">
      <h2 class="text-2xl font-semibold text-blue-400 border-b border-blue-600 pb-1 mb-4">{{ __('site.contact_exp_heading') }}</h2>
      <ul class="list-disc pl-5 text-gray-300 text-sm">
        <li>{!! __('site.contact_exp_item1') !!}</li>
        <li>{!! __('site.contact_exp_item2') !!}</li>
        <li>{!! __('site.contact_exp_item3') !!}</li>
        <li>{!! __('site.contact_exp_item4') !!}</li>
      </ul>
    </section>

    <section class="mb-10">
      <h2 class="text-2xl font-semibold text-purple-400 border-b border-purple-600 pb-1 mb-4">{{ __('site.contact_edu_heading') }}</h2>
      <ul class="list-disc pl-5">
        <li><strong>{{ __('site.contact_edu_school1_name') }}</strong><br><span class="text-sm text-gray-400">{{ __('site.contact_edu_school1_meta') }}</span><br>{{ __('site.contact_edu_school1_desc') }}</li>
        <li class="mt-4"><strong>{{ __('site.contact_edu_school2_name') }}</strong><br><span class="text-sm text-gray-400">{{ __('site.contact_edu_school2_meta') }}</span><br>{{ __('site.contact_edu_school2_desc') }}</li>
      </ul>
    </section>

    <section class="mb-10">
      <h2 class="text-2xl font-semibold text-green-400 border-b border-green-600 pb-1 mb-4">{{ __('site.contact_skills_heading') }}</h2>
