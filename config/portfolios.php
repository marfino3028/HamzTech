 ...
 *   images => daftar screenshot (min 3, kelipatan 3) untuk halaman detail
 *   desc   => deskripsi
 *   tech   => tumpukan teknologi (badge)
 *   url    => tautan live (web/Play Store/App Store), boleh null
 *   type   => 'web' | 'mobile'
 *
 * Catatan gambar: file PNG = screenshot asli; file .svg = placeholder
 * sementara (web login-gated / app mobile). Ganti .svg dgn screenshot
 * asli kapan saja tanpa mengubah struktur.
 */
...
return [
    ...
    'ratapay-quasar-laravel' => [
        ...
        'image' => 'ratapay1.svg',
        'images' => ['ratapay1.svg', 'ratapay2.svg', 'ratapay3.svg'],
    ...
    'hambatan-perdangangan-ci4' => [
        ...
        'image' => 'dpp1.png',
        'images' => ['dpp1.png', 'dpp2.svg', 'dpp3.svg'],
    ...
    'e-sppd-laravel' => [
        ...
        'slug' => 'e-sppd-laravel',
        'image' => 'esppd1.png',
        'images' => ['esppd1.png', 'esppd2.png', 'esppd3.svg'],
    ...
    'mapbyyou-laravel' => [
        ...
        'image' => 'mapbyyou1.png',
        'images' => ['mapbyyou1.png', 'mapbyyou2.png', 'mapbyyou3.svg'],
    ...
    'mirotaklik-erp' => [
        'title' => 'Mirotaklik',
        'slug' => 'mirotaklik-erp',
        'image' => 'mirotaklik1.svg',
        'images' => ['mirotaklik1.svg', 'mirotaklik2.svg', 'mirotaklik3.svg'],
        ...
        'tech' => 'Next.js + Laravel + Flutter',
        'url' => 'https://mirotaklik.id',
        'type' => 'web',
    ],
    ...
    'zhafirah-cms-php' => [
        ...
        'images' => ['zhafirahcms1.png', 'zhafirahcms2.svg', 'zhafirahcms3.svg'],
    ...
    'zhafirah-portal-php' => [
        ...
        'images' => ['zhafirahportal1.png', 'zhafirahportal2.png', 'zhafirahportal3.svg'],
    ...
    'pip-kemenkeu-flutter' => [
        'title' => 'PIP Kemenkeu',
        'slug' => 'pip-kemenkeu-flutter',
        'image' => 'pipkemenkeu1.svg',
        'images' => ['pipkemenkeu1.svg', 'pipkemenkeu2.svg', 'pipkemenkeu3.svg'],
        ...
        'url' => 'https://play.google.com/store/apps/details?id=id.go.kemenkeu.pip.keu',
        'type' => 'mobile',
    ],
    ...
    'momsjourney-flutter' => [
        ...
        'image' => 'momsjourney1.svg',
        'images' => ['momsjourney1.svg', 'momsjourney2.svg', 'momsjourney3.svg'],
    ...
    'dialisacare-flutter' => [
        ...
        'image' => 'dialisacare1.svg',
        'images' => ['dialisacare1.svg', 'dialisacare2.svg', 'dialisacare3.svg'],
    ...
    'zhafirah-marketing-flutter' => [
        ...
        'image' => 'zhafirahmkt1.svg',
        'images' => ['zhafirahmkt1.svg', 'zhafirahmkt2.svg', 'zhafirahmkt3.svg'],
    ...
    'sqp-membership-flutter' => [
        ...
        'image' => 'sqpmembership1.svg',
        'images' => ['sqpmembership1.svg', 'sqpmembership2.svg', 'sqpmembership3.svg'],
    ...
    'wezata-flutter-go' => [
        ...
        'image' => 'wezata1.svg',
        'images' => ['wezata1.svg', 'wezata2.svg', 'wezata3.svg'],
    ...
    'jatrav-flutter' => [
        ...
        'slug' => 'jatrav-flutter',
        'image' => 'jatrav1.svg',
        'images' => ['jatrav1.svg', 'jatrav2.svg', 'jatrav3.svg'],
    ...
    'liburania-reseller-flutter' => [
        'title' => 'Liburania Reseller',
        'slug' => 'liburania-reseller-flutter',
        'image' => 'liburaniareseller1.svg',
        'images' => ['liburaniareseller1.svg', 'liburaniareseller2.svg', 'liburaniareseller3.svg'],
        'desc' => 'Aplikasi untuk jasa agen pembelian tiket wisata (mobile reseller Liburania).',
        'tech' => 'Flutter + CodeIgniter 3',
        'url' => 'https://play.google.com/store/apps/details?id=com.mobilereseller.liburania',
        'type' => 'mobile',
    ],

    'wezata-liburan-flutter' => [
        'title' => 'Wezata (Liburania)',
        'slug' => 'wezata-liburan-flutter',
        'image' => 'wezataliburan1.svg',
        'images' => ['wezataliburan1.svg', 'wezataliburan2.svg', 'wezataliburan3.svg'],
        'desc' => 'Aplikasi liburan wisata untuk pengguna akhir — jelajahi dan pesan paket wisata.',
        'tech' => 'Flutter + CodeIgniter 3',
        'url' => 'https://play.google.com/store/apps/details?id=com.liburania.wezata',
        'type' => 'mobile',
    ],
    ...
    'redeem-jatrav-flutter' => [
        ...
        'image' => 'redeemjatrav1.svg',
        'images' => ['redeemjatrav1.svg', 'redeemjatrav2.svg', 'redeemjatrav3.svg'],
    ...
    'liburania-redeem-flutter' => [
        ...
        'image' => 'liburaniaredeem1.svg',
        'images' => ['liburaniaredeem1.svg', 'liburaniaredeem2.svg', 'liburaniaredeem3.svg'],
    ...
    'redeem-wezata-flutter' => [
        ...
        'image' => 'redeemwezata1.svg',
        'images' => ['redeemwezata1.svg', 'redeemwezata2.svg', 'redeemwezata3.svg'],
