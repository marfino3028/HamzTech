...
<head>
    ...
    <title><?php echo e($title ?? 'HamzTech Portofolio'); ?></title>
...
<body class="font-sans bg-gray-50 text-gray-800">
  ...
  <div class="container mx-auto px-4 py-3 flex justify-between items-center">
    <a href="/" class="flex items-center gap-2">
      <img src="<?php echo e(asset('images/logo.png')); ?>" alt="HamzTech Logo" class="h-10 w-auto">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/freelance/portofolio-it/resources/views/layouts/app.blade.php ENDPATH**/ ?>